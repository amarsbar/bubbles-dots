...
PopupWindow {
    ...
    readonly property int settingsHeight: 194
    ...
    implicitHeight: showingWifi ? (passwordRowSsid !== "" ? passwordHeight : wifiHeight) : showingSound ? soundHeight : showingBluetooth ? bluetoothHeight : settingsHeight
    color: "transparent"
    visible: false
    grabFocus: true
    ...
    ShaderEffect {
        ...
        property color glowAmber:    Qt.rgba(1.000, 0.745, 0.380, 0.08)
        property color glowWhite:    Qt.rgba(1.000, 0.815, 0.484, 0.03)
    ...
    Shape {
        ...
        ShapePath {
            ...
            PathRectangle {
                x: 0; y: 0
                width: bgBorder.width; height: bgBorder.height
                radius: 16
            }
            PathRectangle {
                x: 1; y: 1
                width: bgBorder.width - 2; height: bgBorder.height - 2
                radius: 15
            }
        }
    }
    ...
    Item {
        ...
        opacity: (root.showingWifi || root.showingSound || root.showingBluetooth) ? 0.0 : 1.0
        visible: opacity > 0
        Behavior on opacity { NumberAnimation { duration: 200; easing.type: Easing.OutQuad } }

        // ── Wifi card ──
        Rectangle {
            x: 16; y: 16; width: 94; height: 92; radius: 12
            color: Qt.rgba(0.349, 0.557, 1.0, wifiCardMouse.containsMouse ? 0.25 : 0.15)
        ...
        // ── Bluetooth card ──
        Rectangle {
            x: 122; y: 16; width: 94; height: 92; radius: 12
            color: Qt.rgba(0.349, 0.557, 1.0, btCardMouse.containsMouse ? 0.25 : 0.15)
        ...
        Rectangle {
            id: volumeCard
            x: 16; y: 118; width: 200; height: 60; radius: 12
            color: Qt.rgba(0.349, 0.557, 1.0, 0.25)
    ...
    Item {
        ...
        Rectangle {
            ...
            color: Qt.rgba(0.349, 0.557, 1.0, backMouse.containsMouse ? 0.20 : 0.10)
            Behavior on color { ColorAnimation { duration: 150 } }
        ...
        Rectangle {
            ...
            color: Qt.rgba(0.349, 0.557, 1.0, 0.30)
        ...
        // ── Divider ──
        Rectangle { x: 16; y: 49; width: 200; height: 1; color: Qt.rgba(0.349, 0.557, 1.0, 0.20) }
        ...
        ListView {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    color: Qt.rgba(0.349, 0.557, 1.0, 0.10)
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(0.349, 0.557, 1.0, disconnectMouse.containsMouse ? 0.35 : 0.20)
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }
    ...
    Item {
        ...
        Rectangle {
            ...
            color: Qt.rgba(0.349, 0.557, 1.0, pwBackMouse.containsMouse ? 0.20 : 0.10)
            Behavior on color { ColorAnimation { duration: 150 } }
        ...
        Rectangle {
            ...
            color: Qt.rgba(0.349, 0.557, 1.0, 0.20)
    ...
    Item {
        ...
        Rectangle {
            id: soundBackBtn
            x: 16; y: 12; width: 26; height: 26; radius: 13
            color: Qt.rgba(0.349, 0.557, 1.0, soundBackMouse.containsMouse ? 0.20 : 0.10)
            Behavior on color { ColorAnimation { duration: 150 } }
        ...
        Rectangle {
            ...
            color: Qt.rgba(0.349, 0.557, 1.0, 0.2)
        }
        ...
        ListView {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    radius: 18
                    color: Qt.rgba(0.349, 0.557, 1.0, 0.1)
    ...
    Item {
        ...
        Rectangle {
            id: btBackButton
            x: 16; y: 12; width: 26; height: 26; radius: 13
            color: Qt.rgba(0.349, 0.557, 1.0, btBackMouse.containsMouse ? 0.20 : 0.10)
        ...
        ListView {
            ...
            delegate: Item {
                ...
                Item {
                    ...
                    Rectangle {
                        anchors.fill: parent; radius: 13
                        color: Qt.rgba(0.349, 0.557, 1.0, btConnectMouse.containsMouse ? 0.35 : 0.20)
                    }
                ...
                Item {
                    ...
                    Rectangle {
                        anchors.fill: parent; radius: 13
                        color: Qt.rgba(0.349, 0.557, 1.0, btDisconnectMouse.containsMouse ? 0.35 : 0.20)
                    }
